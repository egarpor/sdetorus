...
knitr::opts_chunk$set(
  ...
  message = FALSE, warning = TRUE, fig.asp = 1, fig.align = 'center'
)
```
...
[![Travis build status](https://travis-ci.org/egarpor/sdetorus.svg?branch=master)](https://travis-ci.org/egarpor/sdetorus)
[![CRAN status](https://www.r-pkg.org/badges/version/sdetorus)](https://cran.r-project.org/package=sdetorus)
<!-- badges: end -->
