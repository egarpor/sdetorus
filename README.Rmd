...
[![Travis-CI Build Status](https://travis-ci.org/egarpor/sdetorus.svg?branch=master)](https://travis-ci.org/egarpor/sdetorus)
...
```{r, example1, message=FALSE, warning=FALSE, fig.asp=1, fig.align='center', cache=TRUE, cache.path="README/"}
# Load package
library(sdetorus)
...
```{r, example2, message=FALSE, fig.asp=1, fig.align='center', cache=TRUE, cache.path="README/"}
# Load package
library(sdetorus)
...
```{r, example3, message=FALSE, fig.asp=1, fig.align='center', cache=TRUE, cache.path="README/"}
# Load package
library(sdetorus)
...
García-Portugués, E., Sørensen, M., Mardia, K. V., and Hamelryck, T. (2019). Langevin diffusions on the torus: estimation and applications. *Statistics and Computing*, 29(2):1--22. <https://doi.org/10.1007/s11222-017-9790-2>
