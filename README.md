...
This library provides statistical tools for Maximum Likelihood Estimation (MLE) of toroidal diffusions. It is the package companion for the paper *Langevin diffusions on the torus: estimation and applications* (García-Portugués et al., 2019).
...
García-Portugués, E., Sørensen, M., Mardia, K. V. and Hamelryck, T. (2019). Langevin diffusions on the torus: estimation and applications. *Statistics and Computing*, <https://doi.org/10.1007/s11222-017-9790-2>.
